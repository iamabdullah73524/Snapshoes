    ...
    <div className="max-w-md mx-auto px-6 py-20">
      <div className="bg-white border border-gray-150 rounded-2xl p-8 shadow-sm space-y-6">
        ...
        <div className="text-center space-y-1.5">
          <h2 className="text-xl font-black uppercase tracking-widest text-brand-dark">Welcome Back</h2>
          <p className="text-xs text-gray-400 font-semibold uppercase tracking-wider">Access your custom sneaker tracker</p>
        </div>
        ...
        <div className="text-center pt-2 border-t border-gray-50 text-xs text-gray-400 font-semibold uppercase tracking-wider">
          ...
          <Link to={`/register${redirect ? `?redirect=${redirect}` : ''}`} className="text-brand-orange hover:underline">
            Register Here
          </Link>
        </div>
